    ...
    async seed() {
        ...
        try {
            ...
            if (existingDayOffs.length === 0) {
                ...
                console.log("База данных прогулов успешно заполнена.");
            } else {
                console.log(
                    "База данных прогулов уже содержит записи. Новые записи не будут добавлены."
                );
            }
        } catch (error) {
            console.error("Ошибка при заполнении базы данных прогулов:", error);
        }
    }
}
