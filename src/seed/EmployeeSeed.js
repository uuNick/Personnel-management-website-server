    ...
    async seed() {
        ...
        try {
            ...
            if (existingEmployees.length === 0) {
                ...
                console.log("Таблица сотрудников успешно заполнена.");
            } else {
                console.log(
                    "Таблица сотрудников уже содержит записи. Новые записи не будут добавлены."
                );
            }
        } catch (error) {
            console.error("Ошибка при заполнении таблицы сотрудников:", error);
        }
    }
}
